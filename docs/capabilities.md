...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Join and identify room | `squad_join`                                                                                                                      | `squad path`, then `squad send` to announce participation                                                                          | MCP join opens a connection lease and returns identity, room, presence, goals, claims and recent history. CLI has no `join` command; `send` opens presence.                                                                        |
